...
Features:
  ...
  * Support for WAV, OGG, VOC, IFF, AIF, AFC, AU, SND, MP3,
     MAT, DWD, SMP, VOX, SDS, AVI, MOV, WMA, FLAC, as well
...
Use the Windows "Add/Remove Programs" feature under Control
...
3.1) Windows 98SE or later is required to run this version.
Do not install on Windows 95 or Windows NT.
...
3.5) This program uses open source software.  GoldWave Inc.
would like to thank and acknowledge the following:
  * zlib library
      Copyright (c) 1995-2005 Jean-loup Gailly and Mark Adler.
      http://www.gzip.org/zlib/
  * Ogg Vorbis library
      Copyright (c) 2004, Xiphophorus
      http://www.xiph.org
  * LAME module
      Many contributors
      http://lame.sourceforge.net/
  * FLAC library
      Copyright (c) 2001-2004  Josh Coalson
...
The package is copyright (c) 2005 by GoldWave Inc.
You are prohibited from:
   charging a fee or requesting donations for the package;
   renting the package;
   defeating shareware limits or using unauthorized licenses;
